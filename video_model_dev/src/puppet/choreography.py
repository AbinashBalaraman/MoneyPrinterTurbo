...
class PuppetChoreographer:
    ...
    def compile(self, total_duration_s: Optional[float] = None) -> np.ndarray:
        ...
        return self.timeline.compile(total_duration_s=total_duration_s)
...
def build_combat_pair(
    ...
    feat_a = tl_a.compile(total_duration_s=dur)  # (T, 30)
    feat_b = tl_b.compile(total_duration_s=dur)  # (T, 30)
