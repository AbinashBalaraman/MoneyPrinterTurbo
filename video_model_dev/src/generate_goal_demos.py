...
from .data_gen import gen_single, gen_pair
...
def generate_light_demo_video(output_path: str = "out/reproduction_light_demo.mp4") -> str:
    ...
    clip_idle = gen_single("idle", duration_s=3.0, seed=1)["feat"]
    clip_block = gen_single("block", duration_s=4.0, amplitude=1.3, seed=2)["feat"]
    clip_celebrate = gen_single("celebrate", duration_s=3.0, seed=3)["feat"]
    ...
    clip_walk = gen_single("walk", duration_s=3.5, speed=0.8, direction=1, seed=10)["feat"]
...
def generate_dark_demo_video(output_path: str = "out/reproduction_dark_demo.mp4") -> str:
    ...
    clip_squat = gen_single("squat", duration_s=4.0, amplitude=1.2, seed=5)["feat"]
    clip_block = gen_single("block", duration_s=3.0, seed=6)["feat"]
    clip_idle = gen_single("idle", duration_s=3.0, seed=7)["feat"]
