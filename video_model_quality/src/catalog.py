...
# Canonical action lists. Defined here (not in data_gen) so the core engine
# never imports the legacy sine generator. data_gen re-exports for back-compat.
ACTIONS_1P: List[str] = ["idle", "walk", "run", "walkback", "jump", "punch",
                         "kick", "block", "wave", "squat", "knockdown", "getup", "celebrate"]
ACTIONS_2P: List[str] = ["punch_block", "kick_dodge", "exchange", "knockdown_getup"]
