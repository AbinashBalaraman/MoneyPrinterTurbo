...
# Re-export canonical action lists from catalog (definitions moved there so the
# core engine no longer imports this legacy module for constants).
from .catalog import ACTIONS_1P, ACTIONS_2P  # noqa: E402,F401
